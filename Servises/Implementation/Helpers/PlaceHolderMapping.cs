    ...
    public static class PlaceHolderMapping
    {
        public static Dictionary<string, string> GetMappings(AnketaDTO anketaDTO)
        {
            return new Dictionary<string, string>
            {
                ...
                { "{PassportIssuedDate}", anketaDTO.passport_issued_date },
                ...
                { "{SpouceBirthday}", anketaDTO.spouce_birthday },
                { "{SpouceWorkPosition}", anketaDTO.spouce_place_of_work_position },
                { "{SpoucePhoneNumber}", anketaDTO.spouce_phone_number },
